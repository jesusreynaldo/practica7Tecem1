	...
	<?php foreach ($result as $fila) {
		# code...
	 	...
	 	echo "<tr>";
	 		...
	 		echo "<td>".$fila['costo_unitario']."</td>";
	 		echo "<td>".$fila['cantidad']."</td>";
	 		echo "<td>".$fila['stock_minimo']."</td>";
	 		echo "<td>".$fila['descripcion2']."</td>";
	 		 
	 		?>
	 		<td><a href="modificaProd.php?id=<?=$fila['id']?>&idc=<?=$fila['id2']?>">Modificar</a></td>
	 		<td><a href="eliminaProd.php?id=<?=$fila['id']?>" onclick="return(confirm('seguro que quiere Eliminar?'))">Eliminar</a></td>
